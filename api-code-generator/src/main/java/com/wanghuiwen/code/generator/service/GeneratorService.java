package com.wanghuiwen.code.generator.service;
...
import static com.wanghuiwen.code.generator.config.ProjectConstant.*;
...
public class GeneratorService {
    ...
    public void genCodeByCustomModelName(String tableName, String modelName, String businessName, boolean isServer, boolean isMapper, boolean isController, boolean isModel, String modulePath, String moduleName) {
        String modelPackage = moduleName.replaceAll("api-", "").replaceAll("-",".");
        if (isModel) {
    ...
    public void genModelAndMapper(String tableName, String modelName, boolean isMapper, String modulePath, String modelPackage) {
        ...
        p2.setConfigurationType("com.wanghuiwen.core.mybatis.NameSpace");
    ...
    public void genService(String tableName, String modelName, String modulePath,String modelPackage) {
        try {
            ...
            logger.info(com.wanghuiwen.core.service.Service.class.getName());
            data.put("baseService", com.wanghuiwen.core.service.Service.class.getName());
            ...
            if (!file.getParentFile().exists()) {
                ...
                if(!mkdir)  throw new ServiceException("目录创建失败");
            }
