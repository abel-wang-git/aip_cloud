package com.wanghuiwen.code.generator.config;

/**
 * 项目常量
 */
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.wanghuiwen.";//项目基础包名称，根据自己公司的项目修改
    ...
    public static final String MAPPER_INTERFACE_REFERENCE = "com.wanghuiwen.core.Mapper";//Mapper插件基础接口的完全限定名
}
